...
c_ReadForceSensor           = CFUNCTYPE(c_int32,c_int32, c_int32, POINTER(c_char), POINTER(c_float), POINTER(c_float), c_int32)(("simxReadForceSensor", libsimx))
c_BreakForceSensor          = CFUNCTYPE(c_int32,c_int32, c_int32, c_int32)(("simxBreakForceSensor", libsimx))
c_ReadVisionSensor          = CFUNCTYPE(c_int32,c_int32, c_int32, POINTER(c_char), POINTER(POINTER(c_float)), POINTER(POINTER(c_int32)), c_int32)(("simxReadVisionSensor", libsimx))
c_GetObjectHandle           = CFUNCTYPE(c_int32,c_int32, POINTER(c_char), POINTER(c_int32), c_int32)(("simxGetObjectHandle", libsimx))
c_GetVisionSensorImage      = CFUNCTYPE(c_int32,c_int32, c_int32, POINTER(c_int32), POINTER(POINTER(c_byte)), c_char, c_int32)(("simxGetVisionSensorImage", libsimx))
c_SetVisionSensorImage      = CFUNCTYPE(c_int32,c_int32, c_int32, POINTER(c_byte), c_int32, c_char, c_int32)(("simxSetVisionSensorImage", libsimx))
...
c_ReadProximitySensor       = CFUNCTYPE(c_int32,c_int32, c_int32, POINTER(c_char), POINTER(c_float), POINTER(c_int32), POINTER(c_float), c_int32)(("simxReadProximitySensor", libsimx))
c_LoadModel                 = CFUNCTYPE(c_int32,c_int32, POINTER(c_char), c_char, POINTER(c_int32), c_int32)(("simxLoadModel", libsimx))
c_LoadUI                    = CFUNCTYPE(c_int32,c_int32, POINTER(c_char), c_char, POINTER(c_int32), POINTER(POINTER(c_int32)), c_int32)(("simxLoadUI", libsimx))
c_LoadScene                 =  CFUNCTYPE(c_int32,c_int32, POINTER(c_char), c_char, c_int32)(("simxLoadScene", libsimx))
...
c_AuxiliaryConsoleShow      = CFUNCTYPE(c_int32,c_int32, c_int32, c_char, c_int32)(("simxAuxiliaryConsoleShow", libsimx))
...
c_SetObjectParent           = CFUNCTYPE(c_int32,c_int32, c_int32, c_int32, c_char, c_int32)(("simxSetObjectParent", libsimx))
...
c_GetBooleanParameter       = CFUNCTYPE(c_int32,c_int32, c_int32, POINTER(c_char), c_int32)(("simxGetBooleanParameter", libsimx))
c_SetBooleanParameter       = CFUNCTYPE(c_int32,c_int32, c_int32, c_char, c_int32)(("simxSetBooleanParameter", libsimx))
...
c_ReadCollision             = CFUNCTYPE(c_int32,c_int32, c_int32, POINTER(c_char), c_int32)(("simxReadCollision", libsimx))
...
c_GetStringSignal           = CFUNCTYPE(c_int32,c_int32, POINTER(c_char), POINTER(POINTER(c_char)), POINTER(c_int32), c_int32)(("simxGetStringSignal", libsimx))
...
c_AppendStringSignal        = CFUNCTYPE(c_int32,c_int32, POINTER(c_char), POINTER(c_char), c_int32, c_int32)(("simxAppendStringSignal", libsimx))
...
c_Start                     = CFUNCTYPE(c_int32,POINTER(c_char), c_int32, c_char, c_char, c_int32, c_int32)(("simxStart", libsimx))
...
c_Synchronous               = CFUNCTYPE(c_int32,c_int32, c_char)(("simxSynchronous", libsimx))
c_PauseCommunication        = CFUNCTYPE(c_int32,c_int32, c_char)(("simxPauseCommunication", libsimx))
...
c_GetAndClearStringSignal   = CFUNCTYPE(c_int32,c_int32, POINTER(c_char), POINTER(POINTER(c_char)), POINTER(c_int32), c_int32)(("simxGetAndClearStringSignal", libsimx))
c_CreateDummy      			= CFUNCTYPE(c_int32,c_int32, c_float, POINTER(c_char), POINTER(c_int32), c_int32)(("simxCreateDummy", libsimx))
c_Query           			= CFUNCTYPE(c_int32,c_int32, POINTER(c_char), POINTER(c_char), c_int32, POINTER(c_char), POINTER(POINTER(c_char)), POINTER(c_int32), c_int32)(("simxQuery", libsimx))
...
def simxGetVisionSensorImage(clientID, sensorHandle, options, operationMode):
    ...
    if (options and 1) != 0:
        bytesPerPixel = 1	
    ret = c_GetVisionSensorImage(clientID, sensorHandle, resolution, byref(c_image), chr(options), operationMode)
...
def simxSetVisionSensorImage(clientID, sensorHandle, image, options, operationMode):
    ...
    return c_SetVisionSensorImage(clientID, sensorHandle, image_bytes, size, chr(options), operationMode)
...
def simxLoadModel(clientID, modelPathAndName, options, operationMode):
    ...
    '''
    baseHandle = c_int()
    return c_LoadModel(clientID, modelPathAndName, chr(options), byref(baseHandle), operationMode), baseHandle.value
...
def simxLoadUI(clientID, uiPathAndName, options, operationMode):
    ...
    ret = c_LoadUI(clientID, uiPathAndName, chr(options), byref(count), byref(uiHandles), operationMode)
...
def simxLoadScene(clientID, scenePathAndName, options, operationMode):
    ...
    return c_LoadScene(clientID, scenePathAndName, chr(options), operationMode)
...
def simxAuxiliaryConsoleShow(clientID, consoleHandle, showState, operationMode):
    ...
    return c_AuxiliaryConsoleShow(clientID, consoleHandle, chr(showState), operationMode)
...
def simxSetObjectParent(clientID, objectHandle, parentObject, keepInPlace, operationMode):
    ...
    return c_SetObjectParent(clientID, objectHandle, parentObject, chr(keepInPlace), operationMode)
...
def simxSetBooleanParameter(clientID, paramIdentifier, paramValue, operationMode):
    ...
    return c_SetBooleanParameter(clientID, paramIdentifier, chr(paramValue), operationMode)
...
def simxStart(connectionAddress, connectionPort, waitUntilConnected, doNotReconnectOnceDisconnected, timeOutInMs, commThreadCycleInMs):
    ...
    return c_Start(connectionAddress, connectionPort, chr(waitUntilConnected), chr(doNotReconnectOnceDisconnected), timeOutInMs, commThreadCycleInMs)
...
def simxSynchronous(clientID, enable):
    ...
    return c_Synchronous(clientID, chr(enable))
...
def simxPauseCommunication(clientID, enable):
    ...
    return c_PauseCommunication(clientID, chr(enable))
